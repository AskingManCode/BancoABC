...
{
    public class ValidadorPersonas : AbstractValidator<Personas>
    {
        public ValidadorPersonas() {

            CascadeMode = CascadeMode.StopOnFirstFailure;

            RuleSet("ValidarPersona", () =>
            {
                // Identificacion
            ...
            RuleSet("ValidarUsuario", () =>
            {
                ...
                // Tipo Usuario
                RuleFor(x => x.Usuario.TipoUsuario)
                    .Must(tipo => tipo == "1" || tipo == "2")
                    .WithMessage("El tipo de usuario debe ser 1 (Administrador) o 2 (Cliente)");
            ...
            /*RuleSet("ValidarModificacionPersona", () => 
            {
                // Identificacion
                RuleFor(x => x.Identificacion)
                    .NotEmpty().WithMessage("El número de identificación es obligatorio.")
